...
- setEventHandlers() - вешает обработчики для закрытия по ESC, overlay, кнопке.
...
#### Класс CartView
Отвечает за отображение содержимого корзины, включая список добавленных товаров и итоговую сумму. Устанавливает слушатели на кнопки удаления товара и перехода к оформлению заказа. 

#### Класс FormStep1View / FormStep2View
